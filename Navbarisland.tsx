...
export default function Navbar({ user, active }: { user?: User | null; active?: string }): JSX.Element {
  ...
  // Use the 'user' and 'active' props as needed
        ...
        <div class="container mx-auto px-4">
          <div class="flex justify-between items-center h-20">
            ...
            <div class="hidden md:flex items-center space-x-8">
              ...
              {user?.role === 'admin' && (
                <a href="/admin/blog" class="text-gray-700 hover:text-primary-600">Post</a>
              )}
